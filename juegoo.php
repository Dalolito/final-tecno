...
$conexion=new mysqli("bkufitykvfrgkuxf0kbo-mysql.services.clever-cloud.com","uwtuotsm55thz4mm","pPisKiEk72fgFQfVWNfu","bkufitykvfrgkuxf0kbo");
$sql="SELECT * FROM final WHERE ID ='$valor'";
$resultado=$conexion->query($sql);
$dato=$resultado->fetch_assoc();

$conexion2=new mysqli("bkufitykvfrgkuxf0kbo-mysql.services.clever-cloud.com","uwtuotsm55thz4mm","pPisKiEk72fgFQfVWNfu","bkufitykvfrgkuxf0kbo");
